...
\begin{document}
  ...
  \section{Concentración de glucosa en sangre}
    \input{slides/glucosa.tex}

  \section{El polinomio interpolador de Lagrange}
    \input{slides/lagrange.tex}
    
  \section{La base de Lagrange}
    \input{slides/base_lagrange.tex}
    \input{slides/ejemplo_lagrange.tex}

  \section{La forma de Newton}
    \input{slides/newton.tex}
    \input{slides/diferencias_divididas.tex}
    \input{slides/ejemplo_newton.tex}

  \section{El error de la interpolación}
    \input{slides/error.tex}
    \input{slides/ejemplo_error.tex}
\end{document}
